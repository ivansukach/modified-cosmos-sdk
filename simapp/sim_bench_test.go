...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/ivansukach/modified-cosmos-sdk/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
