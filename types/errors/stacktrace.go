...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/ivansukach/modified-cosmos-sdk/types/errors.Wrap",
		"github.com/ivansukach/modified-cosmos-sdk/types/errors.Wrapf",
		"github.com/ivansukach/modified-cosmos-sdk/types/errors.WithType",
