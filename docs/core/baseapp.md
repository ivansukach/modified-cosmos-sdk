...
+++ https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/baseapp/baseapp.go#L46-L131
...
possibility to provide additional [`options`](https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/baseapp/options.go)
...
The [default `msgServiceRouter` included in `BaseApp`](https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/baseapp/msg_service_router.go) is stateless. However, some applications may want to make use of more stateful routing mechanisms such as allowing governance to disable certain routes or point them to new modules for upgrade purposes. For this reason, the `sdk.Context` is also passed into each [route handler inside `msgServiceRouter`](https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/baseapp/msg_service_router.go#L31-L32). For a stateless router that doesn't want to make use of this, you can just ignore the `ctx`.
...
+++ https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/store/types/gas.go#L153-L162
...
+++ https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/baseapp/baseapp.go#L623-L630
...
+++ https://github.com/ivansukach/modified-cosmos-sdk/blob/v0.40.0-rc3/types/handler.go#L6-L8
