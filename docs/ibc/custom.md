...
interface](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc/core/05-port/types/module.go). This
...
simple version negotation is implemented in the [ibc-transfer module](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc-transfer/module.go).
...
[`OnRecvPacket`](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc-transfer/module.go).
:::
...
[channel types](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc/core/04-channel/types).

While modules may choose arbitrary acknowledgement structs, a default acknowledgement types is provided by IBC [here](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/proto/ibc/core/channel/v1/channel.proto):
...
[Binding to transfer
port](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/x/ibc-transfer/genesis.go)

[Sending transfer
packets](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/x/ibc-transfer/keeper/relay.go)

[Implementing IBC
callbacks](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/x/ibc-transfer/module.go)
