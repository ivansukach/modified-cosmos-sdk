...
module](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc) to your Cosmos SDK application and
...
by the port
[`Router`](https://github.com/ivansukach/modified-cosmos-sdk/tree/master/x/ibc//core/05-port/types/router.go) on the
IBC module.
...
[`BeginBlock`](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/x/ibc/core/02-client/abci.go) logic as
...
[`SimApp`](https://github.com/ivansukach/modified-cosmos-sdk/blob/master/simapp/app.go).
