...
```bash
go test -v --bench github.com/ivansukach/modified-cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/ivansukach/modified-cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/ivansukach/modified-cosmos-sdk/crypto/keys/mintkey	12.093s
```
